...
public class MostraPaginaRecensione extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String product= req.getParameter("id_prodotto");
        int idProdotto=Integer.parseInt(product);
        int idUtente= utente.getId();
        req.setAttribute("id_prodotto",idProdotto);
        req.setAttribute("id_utente",idUtente);
